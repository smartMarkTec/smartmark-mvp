...
async function runOptimizerBrainDecision({
  ...
  const systemPrompt = [
    ...
    `- Use continue_monitoring only when: campaign is under 24h old, impressions are under 300, a copy or creative change was made in the last 6 hours, or a live creative test is still collecting signal.`,
    ...
    `- When impressions are high (1000+) and CTR is consistently below 0.9%, a copy refresh is overdue — choose update_primary_text.`,
