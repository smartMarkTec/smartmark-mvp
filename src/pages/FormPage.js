...
function LoadingSpinner() {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", width: "100%", height: 150 }}>
      <div style={{ color: "#b0b8bc", fontWeight: 500, fontSize: "0.99rem", marginBottom: 10, letterSpacing: 0.08 }}>
        This could take up to 2 minutes <span role="img" aria-label="robot">🤖</span>
      </div>
      <div style={{ display: "flex", alignItems: "center", height: 44, fontSize: 34, fontWeight: 700, letterSpacing: 1 }}>
...
export default function FormPage() {
  ...
  async function handleUserInput(e) {
    ...
    setChatHistory(ch => [
      ...ch,
      { from: "gpt", text: `Question ${nextStep + 1} of ${CONVO_QUESTIONS.length}\n\n${CONVO_QUESTIONS[nextStep].question}` }
    ]);
    setStep(nextStep);
  }
  ...
  // ======= IMAGE/VIDEO REGENERATE (Same as before) =======
  ...
  return (
    <div style={{ background: DARK_BG, minHeight: "100vh", fontFamily: MODERN_FONT, display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      {/* --------- CHAT BOX PANEL --------- */}
      <div style={{
        width: "100%", maxWidth: 510, minHeight: 280, marginTop: 54, marginBottom: 32,
        background: "#202327", borderRadius: 18, boxShadow: "0 2px 32px #181b2040",
        padding: "34px 24px 20px 24px", display: "flex", flexDirection: "column", alignItems: "center"
      }}>
        {/* Progress bar */}
        ...
        <div ref={chatBoxRef} style={{
          width: "100%", height: 115, maxHeight: 115, overflowY: "auto",
          marginBottom: 14, paddingRight: 4, background: "#191b22", borderRadius: 12
        }}>
      ...
      {/* ------------- AD PREVIEW PANEL: Always visible under chat ------------- */}
      <div style={{
        width: "100%",
        maxWidth: 1000,
        display: "flex",
        ...
        {(mediaType === "image" || mediaType === "both") && (
          <div style={{
            ...
            <div style={{
              ...
              <button
                style={{
                  background: "#1ad6b7", color: "#222", border: "none", borderRadius: 12,
                  fontWeight: 700, fontSize: "1.01rem", padding: "6px 20px",
                  cursor: imageLoading ? "not-allowed" : "pointer", marginLeft: 8,
                  boxShadow: "0 2px 7px #19e5b733", display: "flex", alignItems: "center", gap: 7
                }}
            ...
            <div style={{ background: "#222", display: "flex", alignItems: "center", justifyContent: "center" }}>
              {imageLoading ? (
                ...
                <div style={{
                  height: 220, width: "100%", background: "#e9ecef", color: "#a9abb0", fontWeight: 700,
            ...
            <div style={{ padding: "8px 18px", marginTop: 2 }}>
              <button style={{
                background: "#14e7b9", color: "#181b20", fontWeight: 700, border: "none",
                borderRadius: 9, padding: "8px 20px", fontSize: 15, cursor: "pointer"
              }}>Learn More</button>
            </div>
            ...
            <button
              ...
              onClick={() => {}}
            ><FaEdit style={{ fontSize: 15 }} /> Edit</button>
          </div>
        )}
            ...
            <div style={{
              ...
              <button
                style={{
                  background: "#1ad6b7", color: "#222", border: "none", borderRadius: 12,
                  fontWeight: 700, fontSize: "1.01rem", padding: "6px 20px",
                  cursor: videoLoading ? "not-allowed" : "pointer", marginLeft: 8,
                  boxShadow: "0 2px 7px #19e5b733", display: "flex", alignItems: "center", gap: 7
                }}
